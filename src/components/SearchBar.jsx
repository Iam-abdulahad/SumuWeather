 ...
 */
export default function SearchBar({ onSelectLocation, onUseMyLocation, loading: externalLoading }) {
        ...
        >
          {results.map((loc, index) => (
            <button
              ...
              id={`${resultsId}-${index}`}
            >
              <MapPin size={16} className="mt-0.5 flex-shrink-0 text-amber-flare" />
              <div>
                <p className="font-body text-body font-semibold">{loc.name}</p>
