  ...
  try {
    const response = await axios.get("https://api.open-meteo.com/v1/forecast", {
      params: {
        ...
        hourly:
          "temperature_2m,precipitation,snowfall,relative_humidity_2m,weather_code",
        daily:
    ...
    Swal.fire({
      ...
      text: "Unable to fetch weather data. Please check your internet connection or try again later.",
    });
    return null;
  }
};
